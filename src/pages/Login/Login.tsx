    ...
    >
      <style>{`
        ...
        .glass-panel {
          ...
          background: ${theme === 'dark' ? 'rgba(15, 23, 42, 0.45)' : 'rgba(255, 255, 255, 0.65)'};
        ...
        .glass-input {
          background: ${theme === 'dark' ? 'rgba(9, 15, 28, 0.45)' : 'rgba(255, 255, 255, 0.85)'};
          transition: background-color 400ms ease, border-color 400ms ease, box-shadow 400ms ease, transform 200ms ease;
        }
        .btn-glow {
      ...
      <button
        type="button"
        onClick={toggleTheme}
        className="absolute top-6 right-6 p-2.5 rounded-xl border border-[var(--nu-border)] bg-[var(--nu-surface)] text-[var(--nu-text-secondary)] hover:bg-[var(--nu-surface-alt)] hover:text-[var(--nu-text)] transition-all duration-300 shadow-[var(--nu-shadow-sm)] hover:scale-105 active:scale-95 z-50 cursor-pointer"
      ...
      >
        ...
        <div className="flex-1 lg:w-[55%] flex flex-col justify-between py-6">
          <div className="space-y-4">
            <div className="flex items-center gap-3.5 animate-fade-up">
              <div className="bg-white/95 px-4.5 py-2.5 rounded-[14px] shadow-md border border-white/30 flex items-center justify-center">
                <img 
                  src="/logo.png" 
              ...
              <div>
                ...
                <p className="text-[11px] font-medium text-[var(--nu-text-muted)] tracking-tight leading-none mt-1.5">
            ...
            <div className="pt-2 animate-fade-up delay-100">
              <h1 className="text-[34px] sm:text-[42px] font-extrabold text-[var(--nu-text)] tracking-tight leading-[1.15]">
              ...
              <p className="text-[13.5px] text-[var(--nu-text-muted)] font-medium mt-3 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 lg:mt-10 animate-fade-up delay-200">
            ...
            <div 
              className={`group p-4.5 rounded-2xl border transition-all duration-300 ${
                highlightedCard === 0
                  ? "border-blue-500/35 shadow-md shadow-blue-500/5 bg-[var(--nu-surface)]"
                  : "border-[var(--nu-border)] bg-[var(--nu-surface)]/40 hover:bg-[var(--nu-surface)] hover:shadow-lg hover:-translate-y-0.5"
              }`}
            >
              ...
              <h3 className="text-[13.5px] font-bold text-[var(--nu-text)] mt-3">Live Dashboard</h3>
              <p className="text-[12px] text-[var(--nu-text-muted)] mt-1 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-[13.5px] font-bold text-[var(--nu-text)] mt-3">Project Repository</h3>
              <p className="text-[12px] text-[var(--nu-text-muted)] mt-1 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-[13.5px] font-bold text-[var(--nu-text)] mt-3">Resource Management</h3>
              <p className="text-[12px] text-[var(--nu-text-muted)] mt-1 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-[13.5px] font-bold text-[var(--nu-text)] mt-3">Financial Analytics</h3>
              <p className="text-[12px] text-[var(--nu-text-muted)] mt-1 leading-relaxed">
          ...
          <div className="mt-8 pt-4 border-t border-[var(--nu-border)]/50 flex items-center justify-between text-[11px] text-[var(--nu-text-muted)] font-semibold animate-fade-up delay-300">
        ...
        <div className="lg:w-[45%] flex items-center justify-center w-full">
          <div className={`w-full max-w-[440px] glass-panel rounded-[24px] p-8 lg:p-9 shadow-2xl relative overflow-hidden animate-fade-up delay-200 ${
            ...
            {isSuccess && (
              <div className="absolute inset-0 bg-[var(--nu-surface)]/95 flex flex-col items-center justify-center text-center p-6 z-30 animate-in fade-in duration-300 rounded-[24px]">
                ...
                <h3 className="text-[17px] font-bold text-[var(--nu-text)]">
                  ✔ Authentication Successful
                </h3>
                <p className="text-[13.5px] text-[var(--nu-text-muted)] mt-1.5 leading-relaxed">
            ...
            <div className="text-center mb-6 animate-fade-up delay-300">
              ...
              <h2 className="text-[20px] font-extrabold text-[var(--nu-text)] tracking-tight">
                Welcome Back
              </h2>
            ...
            {failedAttempts >= 3 && (
              <div className="flex items-start gap-2.5 rounded-xl border border-[var(--nu-warning)]/25 bg-[var(--nu-warning-soft)] p-3.5 text-[12px] font-medium text-[var(--nu-warning)] mb-5 animate-in fade-in duration-300">
            ...
            {authError && (
              <div className="flex flex-col gap-2 rounded-xl border border-[var(--nu-danger)]/25 bg-[var(--nu-danger-soft)] p-3.5 text-[12px] font-medium text-[var(--nu-danger)] mb-5 animate-in fade-in slide-in-from-top-3 duration-300">
                ...
                <button
                  type="button"
                  onClick={handleRetry}
                  className="text-left text-[11px] font-bold text-red-600 dark:text-red-400 hover:underline pl-6.5 cursor-pointer border-none bg-transparent outline-none"
                >
                  ↻ Try Again
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="space-y-4.5">
              ...
              <div className="space-y-1.5 animate-fade-up delay-400">
                <label className="block text-[11px] font-bold text-[var(--nu-text-secondary)] uppercase tracking-wider">
                  Employee ID
                </label>
                <div className="relative">
                  <span className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${
                    isIdFocused ? "text-blue-500" : "text-[var(--nu-text-muted)]"
                  }`}>
                    <User size={15} />
                  </span>
                  <input
                    ...
                    className={`w-full h-10.5 pl-10 pr-4 rounded-xl border glass-input text-[13px] text-[var(--nu-text)] outline-none focus:scale-[1.01] focus:shadow-md focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 ${
                      errors.employeeId
                        ? "border-[var(--nu-danger)] focus:ring-[var(--nu-danger)]/15 focus:border-[var(--nu-danger)]"
                        : "border-[var(--nu-border)]"
                    }`}
                  />
                </div>
                {errors.employeeId && (
                  <p className="text-[11px] text-[var(--nu-danger)] font-semibold mt-1 animate-in fade-in duration-200">
                    {errors.employeeId}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-1.5 animate-fade-up delay-500">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[11px] text-[var(--nu-text-muted)] cursor-not-allowed hover:underline font-semibold">
                    Forgot Password?
                  </span>
                </div>
                <div className="relative">
                  <span className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${
                    isPassFocused ? "text-blue-500" : "text-[var(--nu-text-muted)]"
                  }`}>
                    <Lock size={15} />
                  </span>
                  <input
                    ...
                    className={`w-full h-10.5 pl-10 pr-11 rounded-xl border glass-input text-[13px] text-[var(--nu-text)] outline-none focus:scale-[1.01] focus:shadow-md focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 ${
                      errors.password || authError
                        ? "border-[var(--nu-danger)] focus:ring-[var(--nu-danger)]/15 focus:border-[var(--nu-danger)] shadow-[0_0_8px_rgba(239,68,68,0.2)]"
                        : "border-[var(--nu-border)]"
                    }`}
                  />
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[var(--nu-text-muted)] hover:text-[var(--nu-text)] transition-colors cursor-pointer"
                    tabIndex={-1}
                  >
              ...
              <div className="flex items-center pt-1 animate-fade-up delay-600">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <input
                    ...
                    className="w-4 h-4 rounded-lg border-[var(--nu-border)] text-blue-600 focus:ring-blue-500 focus:ring-offset-[var(--nu-surface)] cursor-pointer"
                  />
                  <span className="text-[12px] text-[var(--nu-text-secondary)] font-semibold">
            ...
            <div className="text-center mt-7 pt-6 border-t border-[var(--nu-border)]/50 flex flex-col gap-1 animate-fade-up delay-800">
              <p className="text-[10px] font-extrabold text-[var(--nu-text-muted)] uppercase tracking-widest">
                For Internal Company Use Only
              </p>
              <p className="text-[9.5px] font-bold text-[var(--nu-text-muted)]/60">
