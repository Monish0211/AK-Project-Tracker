      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-[15px] font-semibold text-[var(--nu-text)]">Delete Customer?</h2>
            <p className="text-[12.5px] text-[var(--nu-text-secondary)] mt-1">
              Remove <span className="font-medium text-[var(--nu-text)]">"{customerName}"</span>? This action cannot
              be undone.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-2.5 mt-5">
          ...
          <Button
            ...
            size="sm"
            onClick={onConfirm}
            className="!bg-[var(--nu-danger)] hover:!bg-red-700"
          >
            Delete
          </Button>
        </div>
