  ...
  const tiles = [
    {
      ...
      rawValue: summary.projectValueINR,
    ...
    },
    {
      ...
      rawValue: summary.totalInvoiceRaised,
    ...
    },
    {
      ...
      rawValue: summary.outstandingCollection,
    ...
    },
    {
      ...
      rawValue: summary.totalPaymentReceived,
      icon: <Wallet size={16} />,
