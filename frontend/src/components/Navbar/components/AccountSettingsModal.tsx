          ...
          <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-[#1E293B]">
            {activeTab === "general" && (
              <div className="space-y-4">
                <h4 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">General Settings</h4>
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wide">PMO Portal Version</label>
                  <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 mt-0.5">v2.1.0-prod</p>
                </div>
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Organizational Unit</label>
                  <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 mt-0.5">iFluids Chennai HQ</p>
                </div>
              </div>
            )}
            ...
            {activeTab === "notifications" && (
              <div className="space-y-5">
                <h4 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Notification Preferences</h4>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">Desktop Push Notifications</p>
            ...
            {activeTab === "security" && (
              <div className="space-y-4">
                <h4 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Security Preferences</h4>
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      disabled
                      className="w-full mt-1.5 px-3 py-2 border border-gray-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 rounded-xl text-sm outline-none cursor-not-allowed text-slate-800 dark:text-slate-200"
                    />
                  </div>
                  <div>
            ...
            {activeTab === "theme" && (
              <div className="space-y-4">
                <h4 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Theme Preferences</h4>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2.5 justify-center py-3.5 border rounded-2xl transition font-semibold text-sm ${
                      theme === "light"
                        ...
                        : "border-gray-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200"
                    }`}
                  >
                    <Sun size={16} />
            ...
            {activeTab === "language" && (
              <div className="space-y-4">
                <h4 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Language Preferences</h4>
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Language</label>
                  <select
                    value={language}
                    onChange={(e) => setLanguage(e.target.value)}
                    className="w-full mt-1.5 px-3 py-2 border border-gray-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 rounded-xl text-sm outline-none font-semibold text-slate-800 dark:text-slate-200"
                  >
